...
class _Plugin_bm3dcuda_Core_Unbound(Plugin):
    ...
    This class cannot be imported.
    """
    def BM3D(self, clip: "VideoNode", ref: typing.Optional["VideoNode"] = None, sigma: typing.Union[float, typing.Sequence[float], None] = None, block_step: typing.Union[int, typing.Sequence[int], None] = None, bm_range: typing.Union[int, typing.Sequence[int], None] = None, radius: typing.Optional[int] = None, ps_num: typing.Union[int, typing.Sequence[int], None] = None, ps_range: typing.Union[int, typing.Sequence[int], None] = None, chroma: typing.Optional[int] = None, device_id: typing.Optional[int] = None, fast: typing.Optional[int] = None, extractor_exp: typing.Optional[int] = None, unsafe: typing.Optional[int] = None) -> "VideoNode": ...
    def MakeBuffer(self, clip: "VideoNode") -> "VideoNode": ...
    def VAggregate(self, clip: "VideoNode", signal: "VideoNode", radius: int, process: typing.Union[int, typing.Sequence[int], None] = None) -> "VideoNode": ...
...
class _Plugin_bm3dcuda_VideoNode_Bound(Plugin):
    ...
    def MakeBuffer(self) -> "VideoNode": ...
    def VAggregate(self, signal: "VideoNode", radius: int, process: typing.Union[int, typing.Sequence[int], None] = None) -> "VideoNode": ...
